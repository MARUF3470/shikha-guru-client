                            ...
                            <div className=''>
                                {
                                    user?.uid ? <div className='mt-2'><img className="w-10 mr-1 rounded-full inline " title={displayName} src={photoURL} alt="" />
                                        <button className='btn btn-sm btn-ghost' onClick={handleLogout}>Log Out</button></div> : <div><li><Link className='btn btn-ghost justify-start' to='/login'>Login</Link></li>
                                        <li><Link className='btn btn-ghost justify-start' to='/register'>Register</Link></li></div>
                                }
                            </div>
                        </ul>
                    </div>
                ...
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal p-0">
                        ...
                        <div className=''>
                            {
                                user?.uid ? <div className='mt-2'><img className="w-10 mr-1 rounded-full inline " title={displayName} src={photoURL} alt="" />
                                    <button className='btn btn-sm btn-ghost' onClick={handleLogout}>Log Out</button></div> : <div className='flex'><li><Link className='btn btn-ghost justify-start' to='/login'>Login</Link></li>
                                    <li><Link className='btn btn-ghost justify-start' to='/register'>Register</Link></li></div>
                            }
                        </div>
                    </ul>
